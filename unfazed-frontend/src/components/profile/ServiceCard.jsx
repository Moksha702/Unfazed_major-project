  ...
  return (
    <div className="mb-10">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {/* Single Session Card */}
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between hover:border-amber-300 transition-all">
          <div>
        ...
        {packages.map((pkg) => (
          <div
            key={pkg._id}
            className="bg-white rounded-2xl p-6 border-2 border-amber-500 shadow-lg shadow-amber-50 flex flex-col justify-between relative overflow-hidden"
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <span className="text-xs font-bold uppercase tracking-wider text-orange-500">Package Bundle</span>
                <span className="p-2 rounded-xl bg-amber-50 text-orange-500">
              ...
              <div className="mb-6">
                <span className="text-3xl font-black text-stone-950">₹{pkg.price}</span>
