...
# Run seeder with realistic test data (Therapist, Clients, Sessions, Notes, Invoices)
npm run seed
...
| Role | Details |
| :--- | :--- |
| **Therapist Account** | **Email:** `dr.sharma@unfazed.in`<br>**Password:** `Password123!` |
| **Public Branded Page** | `http://localhost:5173/dr-sharma` |
| **Client Portal Demo** | `http://localhost:5173/portal/client-demo` |
| **Therapist Dashboard** | `http://localhost:5173/dashboard` |
